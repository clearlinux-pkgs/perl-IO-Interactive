...
%prep
%setup -q -n IO-Interactive-1.027
cd %{_builddir}
tar xf %{_sourcedir}/libio-interactive-perl_1.022-1.debian.tar.xz
cd %{_builddir}/IO-Interactive-1.027
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/IO-Interactive-1.027/deblicense/
pushd ..
cp -a IO-Interactive-1.027 buildavx2
popd
